        ...
        <div className="flex flex-col items-center">
          ...
          <div className="bg-white/50 w-10/12 px-6 pb-16 app-shadow rounded-xl mt-10 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div className="bg-white/80 flex flex-col border-2 border-white shadow-xl rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-white duration-300">
                <Link to="/add">
                  ...
                  <h1 className="font-semibold xs:text-xs app-color-black text-center">Add Recruiters</h1>
                </Link>
              </div>

              <div className="bg-white/80 mx-6 flex flex-col rounded-lg border-2 border-white shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-white duration-300">
                <Link to="/add-internship">
                  ...
                  <h1 className="font-semibold text-lg app-color-pink text-center xs:text-xs text-wrap">Update Internships</h1>
                </Link>
              </div>

              <div className="bg-white/80 mx-6 flex flex-col border-2 border-white shadow-xl rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-white duration-300">
                <Link to="/scheduler">
                  ...
                  <h1 className="font-semibold text-lg app-color-black text-center">Update Schedule</h1>
                </Link>
              </div>
            </div>
          </div>
