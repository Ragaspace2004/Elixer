...
export default function CompanyList() {
  const { data: jobs, loading, error } = useFetch({
    url: 'https://test3.ragapriya-k2022cse.workers.dev/jobs-upcoming/sql/get-all',
  });

  return (
    
     <div id="top-card" className="w-full bg-cyan-200 rounded-xl ">
     <div className="">
       <nav className='flex flex-row items-center justify-between  font-bold text-xl py-5 '>
        <ul>
          <Link to ="/">Ongoing Placements</Link>
        </ul>
        <ul>
        ...
        <div className="bg-white  rounded-xl flex flex-col gap-5 px-10 ">
          <h1 className="text-3xl font-sans font-bold flex justify-center">Upcoming</h1>
